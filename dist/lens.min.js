...
this.aIconInfo.halfHeight:a.height)+this.yIconOffset)}});VYLO.delDiob(f);EListener.on(VYLO.Client,"onScreenRender",function(a){if(e.init){const b=Date.now();this.___EVITCA_aPause&&aPause&&aPause.paused||(e.settings.loop.lastTime||(e.settings.loop.lastTime=b),a=(b-e.settings.loop.lastTime)/1E3,e.settings.loop.elapsedMS=b-e.settings.loop.lastTime,.033<a&&(a=.033),e.settings.loop.deltaTime=a,this.___EVITCA_aParallax&&e.attached&&this.aParallax.update(e.following.getTrueCenterPos().x-e.oldPos.x,e.following.getTrueCenterPos().y-
e.oldPos.y),e.update(e.settings.loop.elapsedMS,e.settings.loop.deltaTime));e.settings.loop.lastTime=b}});VYLO.Client.attachCamera=function(a){e.settings.zoom.currentLevel.x=this.mapView.scale.x;e.settings.zoom.currentLevel.y=this.mapView.scale.y;e.assignIconSize(this.mob);e.following=this.mob;e.setPos(this.mob.getTrueCenterPos().x,this.mob.getTrueCenterPos().y,this.mob.mapName);e.oldPos.x=e.xPos;e.oldPos.y=e.yPos;e.attached=!0;a?"object"===typeof a&&a.constructor===Object?(a.duration?"object"===typeof a.duration&&
a.duration.constructor===Object?"number"===typeof a.duration.x&&"number"===typeof a.duration.y?(e.settings.custom.duration.x=a.duration.x,e.settings.custom.duration.y=a.duration.y):(e.settings.custom.duration.x=e.settings.custom.duration.y=1E3,this.debugging&&console.warn("Lens: Invalid variable type passed for the %cpSettings.duration.x || pSettings.duration.y","font-weight: bold","property. Reverted to default")):typeof("number"===a.duration)?e.settings.custom.duration.x=e.settings.custom.duration.y=
a.duration:(e.settings.custom.duration.x=e.settings.custom.duration.y=1E3,this.debugging&&console.warn("Lens: Invalid variable type passed for the %cpSettings.duration","font-weight: bold","property. Reverted to default")):(e.settings.custom.duration.x=e.settings.custom.duration.y=1E3,this.debugging&&console.warn("Lens: No %cpSettings.duration","font-weight: bold","parameter passed. Reverted to default")),a.ease?"object"===typeof a.ease&&a.ease.constructor===Object?"string"===typeof a.ease.x&&"string"===
typeof a.ease.y?k.includes(a.ease.x)&&k.includes(a.ease.y)?(e.settings.custom.ease.x=a.ease.x,e.settings.custom.ease.y=a.ease.y):(e.settings.custom.ease.x=e.settings.custom.ease.y="easeOutCubic",this.debugging&&console.warn("Lens: Invalid %cease","font-weight: bold","name passed for pSettings.ease.x || pSettings.ease.y. Reverted to default")):(e.settings.custom.ease.x=e.settings.custom.ease.y="easeOutCubic",this.debugging&&console.warn("Lens: Invalid variable type passed for the %cpSettings.ease.x || pSettings.ease.y",
"font-weight: bold","property. Reverted to default")):typeof("string"===a.ease)?k.includes(a.ease)?e.settings.custom.ease.x=e.settings.custom.ease.y=a.ease:(e.settings.custom.ease.x=e.settings.custom.ease.y="easeOutCubic",this.debugging&&console.warn("Lens: Invalid %cease","font-weight: bold","name passed for pSettings.ease. Reverted to default")):(e.settings.custom.ease.x=e.settings.custom.ease.y="easeOutCubic",this.debugging&&console.warn("Lens: Invalid variable type passed for the %cpSettings.ease",
"font-weight: bold","property. Reverted to default")):(e.settings.custom.ease.x=e.settings.custom.ease.y="easeOutCubic",this.debugging&&console.warn("Lens: No %cpSettings.ease","font-weight: bold","parameter passed. Reverted to default")),e.reset("standard"),e.custom=!0,this.following=this.mob,e.settings.custom.initialPos.x=e.xPos,e.settings.custom.initialPos.y=e.yPos):(e.reset("custom"),e.custom=!1,e.following=this.mob,e.settings.standard.initialPos.x=e.xPos,e.settings.standard.initialPos.y=e.yPos,
...
(a/=d/2)?c/2*a*a*a+b:c/2*((a-=2)*a*a+2)+b},easeInQuart:function(a,b,c,d){return c*(a/=d)*a*a*a+b},easeOutQuart:function(a,b,c,d){return-c*((a=a/d-1)*a*a*a-1)+b},easeInOutQuart:function(a,b,c,d){return 1>(a/=d/2)?c/2*a*a*a*a+b:-c/2*((a-=2)*a*a*a-2)+b},easeInQuint:function(a,b,c,d){return c*(a/=d)*a*a*a*a+b},easeOutQuint:function(a,b,c,d){return c*((a=a/d-1)*a*a*a*a+1)+b},easeInOutQuint:function(a,b,c,d){return 1>(a/=d/2)?c/2*a*a*a*a*a+b:c/2*((a-=2)*a*a*a*a+2)+b},easeInElastic:function(a,b,c,d){var g=
0,h=c;if(0==a)return b;if(1==(a/=d))return b+c;g||(g=.3*d);h<Math.abs(c)?(h=c,c=g/4):c=g/(2*Math.PI)*Math.asin(c/h);return-(h*Math.pow(2,10*--a)*Math.sin(2*(a*d-c)*Math.PI/g))+b},easeOutElastic:function(a,b,c,d){var g=0,h=c;if(0==a)return b;if(1==(a/=d))return b+c;g||(g=.3*d);if(h<Math.abs(c)){h=c;var l=g/4}else l=g/(2*Math.PI)*Math.asin(c/h);return h*Math.pow(2,-10*a)*Math.sin(2*(a*d-l)*Math.PI/g)+c+b},easeInOutElastic:function(a,b,c,d){var g=0,h=c;if(0==a)return b;if(2==(a/=d/2))return b+c;g||(g=
.3*d*1.5);if(h<Math.abs(c)){h=c;var l=g/4}else l=g/(2*Math.PI)*Math.asin(c/h);return 1>a?-.5*h*Math.pow(2,10*--a)*Math.sin(2*(a*d-l)*Math.PI/g)+b:h*Math.pow(2,-10*--a)*Math.sin(2*(a*d-l)*Math.PI/g)*.5+c+b},easeInBack:function(a,b,c,d){return c*(a/=d)*a*(2.70158*a-1.70158)+b},easeOutBack:function(a,b,c,d){return c*((a=a/d-1)*a*(2.70158*a+1.70158)+1)+b},easeInOutBack:function(a,b,c,d){var g=1.70158;return 1>(a/=d/2)?c/2*a*a*(((g*=1.525)+1)*a-g)+b:c/2*((a-=2)*a*(((g*=1.525)+1)*a+g)+2)+b},easeInBounce:function(a,
b,c,d){return c-this.easeOutBounce(d-a,0,c,d)+b},easeOutBounce:function(a,b,c,d){a/=d;if(a<1/2.75)return 7.5625*c*a*a+b;if(a<2/2.75)return a-=1.5/2.75,c*(7.5625*a*a+.75)+b;if(a<2.5/2.75)return a-=2.25/2.75,c*(7.5625*a*a+.9375)+b;a-=2.625/2.75;return c*(7.5625*a*a+.984375)+b},easeInOutBounce:function(a,b,c,d){return a<.5*d?.5*this.easeInBounce(2*a,0,c,d)+b:.5*this.easeOutBounce(2*a-d,0,c,d)+.5*c+b}},f=VYLO.newDiob();f.atlasName="";f.width=1;f.height=1;f.color={tint:16738740};f.mouseOpacity=0;f.touchOpacity=
0;f.density=0;f.plane=1;f.layer=999999;f.invisibility=999999;f.custom=!1;f.owner=VYLO.Client;f.following=null;f.debugging=!1;f.preventScreenRelayer=!0;f.preventInterpolation=!0;f.ONE=1;f.TWO=2;f.THREE=3;f.FOUR=4;f.FIVE=5;f.SIX=6;f.oldPos={x:0,y:0};f.oldFollowingPos={x:0,y:0};f.settings={zoom:{active:{x:!1,y:!1},time:{x:0,y:0},duration:{x:1E3,y:1E3},initialLevel:{x:null,y:null},currentLevel:{x:null,y:null},destinationLevel:{x:null,y:null},differenceLevel:{x:null,y:null},ease:{x:"easeOutCubic",y:"easeOutCubic"},
callback:null},shake:{active:{x:!1,y:!1},time:{x:0,y:0},duration:{x:1E3,y:1E3},intensity:{x:1,y:1},rotational:!1,concurrentShaking:[],callback:null},pan:{active:{x:!1,y:!1},time:{x:0,y:0,z:0},destination:{x:null,y:null},ease:{x:"easeOutCubic",y:"easeOutCubic"},duration:{x:1E3,y:1E3},target:null,storedDir:null,returning:null,forceDirChange:!0,pauseDuration:0,attach:!1,initialPos:{x:null,y:null},finalDuration:{x:1E3,y:1E3},finalEase:{x:"easeOutCubic",y:"easeOutCubic"},pannedCallback:null,finalCallback:null},
scroll:{active:!1,time:0,duration:null,ease:null},standard:{active:{x:!1,y:!1},time:{x:0,y:0},duration:{x:1E3,y:1E3},destination:{x:null,y:null},initialPos:{x:null,y:null},ease:{x:"easeOutCubic",y:"easeOutCubic"}},custom:{active:{x:!1,y:!1},time:{x:0,y:0},duration:{x:1E3,y:1E3},destination:{x:null,y:null},initialPos:{x:null,y:null},ease:{x:"easeOutCubic",y:"easeOutCubic"}},spectate:{forcePos:!0,preventMovement:!0,player:null},loop:{lastTime:0,deltaTime:0,elapsedMS:0},zooming:!1,panning:!1,scrolling:!1,
spectating:!1,shaking:!1};f.decimalRand=function(a,b,c=1){a=Number((Math.random()*(a-b)+b).toFixed(c));return 1<=a?Math.floor(a):a};f.assignIconSize=function(a){if(!a.aIconInfo){var b=(a.atlasName+"_"+(a.iconName?a.iconName:"")+"_"+(a.iconState?a.iconState:"")).trim();a.aIconInfo={};this.cachedResourcesInfo[b]?a.aIconInfo=JSON.parse(JSON.stringify(this.cachedResourcesInfo[b])):(a.aIconInfo.width=Math.round(m.width),a.aIconInfo.height=Math.round(m.height),a.aIconInfo.halfWidth=Math.round(m.width/2),
a.aIconInfo.halfHeight=Math.round(m.height/2));var c=function(){const d=VYLO.Icon.getIconSize(a.atlasName,a.iconName);this.cachedResourcesInfo[b]={width:Math.round(d.width),height:Math.round(d.height),halfWidth:Math.round(d.width/2),halfHeight:Math.round(d.height/2)};a.aIconInfo.width=this.cachedResourcesInfo[b].width;a.aIconInfo.height=this.cachedResourcesInfo[b].height;a.aIconInfo.halfWidth=this.cachedResourcesInfo[b].halfWidth;a.aIconInfo.halfHeight=this.cachedResourcesInfo[b].halfHeight};a.atlasName?
VYLO.Resource.loadResource("icon",a.atlasName,c.bind(this)):console.warn("Lens: No %cpDiob.atlasName","font-weight: bold","to load.")}};f.reset=function(a){switch(a){case "zoomX":this.settings.zoom.active.x=!1;this.settings.zoom.time.x=0;this.settings.zoom.ease.x="easeOutCirc";break;case "zoomY":this.settings.zoom.active.y=!1;this.settings.zoom.time.y=0;this.settings.zoom.ease.y="easeOutCirc";break;case "zoom":this.settings.zoom.callback=null;this.settings.zoom.time.x=this.settings.zoom.time.y=0;
this.settings.zoom.active.x=this.settings.zoom.active.y=!1;this.settings.zoom.initialLevel.x=this.settings.zoom.initialLevel.y=null;this.settings.zoom.destinationLevel.x=this.settings.zoom.destinationLevel.y=null;this.settings.zoom.differenceLevel.x=this.settings.zoom.differenceLevel.y=null;this.settings.zoom.duration.x=this.settings.zoom.duration.y=null;this.settings.zoom.ease.x=this.settings.zoom.ease.y=null;this.isZooming=this.settings.zooming=!1;break;case "panX":this.settings.pan.active.x=!1;
this.settings.pan.time.x=0;break;case "panY":this.settings.pan.active.y=!1;this.settings.pan.time.y=0;break;case "pan":this.settings.pan.returning=!1;this.settings.pan.attach=!1;this.settings.pan.forceDirChange=!0;this.settings.pan.target=null;this.settings.pan.storedDir=null;this.settings.pan.pannedCallback=null;this.settings.pan.finalCallback=null;this.settings.pan.pauseDuration=0;this.settings.pan.time.x=this.settings.pan.time.y=0;this.settings.pan.initialPos.x=this.settings.pan.initialPos.y=null;
this.settings.pan.finalDuration.x=this.settings.pan.finalDuration.y=null;this.settings.pan.ease.x=this.settings.pan.ease.y=null;this.settings.pan.finalEase.x=this.settings.pan.finalEase.y=null;this.settings.pan.active.x=this.settings.pan.active.y=!1;this.settings.pan.duration.x=this.settings.pan.duration.y=null;this.settings.pan.destination.x=this.settings.pan.destination.y=null;this.isPanning=this.settings.panning=!1;break;case "standardX":this.settings.standard.active.x=!1;this.settings.standard.time.x=
0;this.settings.standard.initialPos.x=this.xPos;break;case "standardY":this.settings.standard.active.y=!1;this.settings.standard.time.y=0;this.settings.standard.initialPos.y=this.yPos;break;case "standard":this.settings.standard.active.x=this.settings.standard.active.y=!1;this.settings.standard.time.x=this.settings.standard.time.y=0;this.settings.standard.initialPos.x=this.xPos;this.settings.standard.initialPos.y=this.yPos;this.isMoving=!1;break;case "customX":this.settings.custom.active.x=!1;this.settings.custom.time.x=
0;this.settings.custom.initialPos.x=this.xPos;break;case "customY":this.settings.custom.active.y=!1;this.settings.custom.time.y=0;this.settings.custom.initialPos.y=this.yPos;break;case "custom":this.settings.custom.active.x=this.settings.custom.active.y=!1;this.settings.custom.time.x=this.settings.custom.time.y=0;this.settings.custom.initialPos.x=this.xPos;this.settings.custom.initialPos.y=this.yPos;this.isMoving=!1;break;case "scroll":this.settings.scrolling=!1;break;case "shakeX":this.settings.shake.time.x=
0;this.settings.shake.active.x=!1;VYLO.Client.setViewEyeOffsets(0,VYLO.Client.getViewEyeOffsets().y);break;case "shakeY":this.settings.shake.time.y=0;this.settings.shake.active.y=!1;VYLO.Client.setViewEyeOffsets(VYLO.Client.getViewEyeOffsets().x,0);break;case "shake":this.settings.shake.callback=null;this.settings.shake.rotational=!1;this.settings.shake.time.x=this.settings.shake.time.y=0;this.settings.shake.active.x=this.settings.shake.active.y=!1;this.settings.shake.duration.x=this.settings.shake.duration.y=
0;this.settings.shake.intensity.x=this.settings.shake.intensity.y=0;VYLO.Client.setViewEyeOffsets(0,0);VYLO.Client.mapView.angle=0;VYLO.Client.setMapView(VYLO.Client.mapView);this.isShaking=!1;break;case "spectate":this.settings.spectate.player=null,this.settings.spectate.forcePos=!1,this.settings.spectate.preventMovement=!1,this.isSpectating=this.settings.spectating=!1}};f.zoomUpdate=function(a,b){this.settings.zoom.active.x&&(this.settings.zoom.time.x=Math.min(this.settings.zoom.time.x+a,this.settings.zoom.duration.x),
this.settings.zoom.currentLevel.x=e[this.settings.zoom.ease.x](this.settings.zoom.time.x,this.settings.zoom.initialLevel.x,this.settings.zoom.differenceLevel.x,this.settings.zoom.duration.x),VYLO.Client.mapView.scale.x+=this.settings.zoom.currentLevel.x-VYLO.Client.mapView.scale.x);this.settings.zoom.active.y&&(this.settings.zoom.time.y=Math.min(this.settings.zoom.time.y+a,this.settings.zoom.duration.y),this.settings.zoom.currentLevel.y=e[this.settings.zoom.ease.y](this.settings.zoom.time.y,this.settings.zoom.initialLevel.y,
this.settings.zoom.differenceLevel.y,this.settings.zoom.duration.y),VYLO.Client.mapView.scale.y+=this.settings.zoom.currentLevel.y-VYLO.Client.mapView.scale.y);VYLO.Client.setMapView(VYLO.Client.mapView);this.settings.zoom.time.x===this.settings.zoom.duration.x&&this.reset("zoomX");this.settings.zoom.time.y===this.settings.zoom.duration.y&&this.reset("zoomY");if(!this.settings.zoom.active.x&&!this.settings.zoom.active.y)this.onZoomEnd()};f.shakeUpdate=function(a,b){if(this.settings.shake.rotational){let g,
h;this.settings.shake.active.x&&this.settings.shake.active.y?(g=this.settings.shake.intensity.x,h=this.settings.shake.intensity.y):this.settings.shake.active.x?(g=this.settings.shake.intensity.x,h=.5*g):this.settings.shake.active.y&&(g=this.settings.shake.intensity.y,h=.5*g);b=this.decimalRand(-this.decimalRand(g,h)/200,this.decimalRand(g,h)/200);VYLO.Client.mapView.angle=b;VYLO.Client.setMapView(VYLO.Client.mapView)}if(this.settings.shake.active.x){var c=this.settings.shake.intensity.x;b=.5*c;c=
this.decimalRand(-this.decimalRand(c,b),this.decimalRand(c,b));this.settings.shake.time.x=Math.min(this.settings.shake.time.x+a,this.settings.shake.duration.x)}if(this.settings.shake.active.y){var d=this.settings.shake.intensity.y;b=.5*d;d=this.decimalRand(-this.decimalRand(d,b),this.decimalRand(d,b));this.settings.shake.time.y=Math.min(this.settings.shake.time.y+a,this.settings.shake.duration.y)}VYLO.Client.setViewEyeOffsets(c?c:0,d?d:0);this.settings.shake.time.x===this.settings.shake.duration.x&&
this.reset("shakeX");this.settings.shake.time.y===this.settings.shake.duration.y&&this.reset("shakeY");if(!this.settings.shake.active.x&&!this.settings.shake.active.y)this.onShakeEnd()};f.pan=function(a){if(this.settings.panning&&!this.settings.pan.returning)console.error("Lens: You are already %cpanning","font-weight: bold",". Pan failed");else if(this.settings.spectating)console.error("Lens: You are %cspectating","font-weight: bold","and cannot pan right now. Pan failed");else{if("object"===typeof a&&
a.constructor===Object)if(Object.keys(a).includes("target")){if("object"===typeof a.target&&a.target.constructor===Diob)if("number"===typeof a.target.xPos&&"number"===typeof a.target.yPos&&"string"===typeof a.target.mapName){if(a.target===this.following){console.error("Lens: You %ccannot","font-weight: bold","pan to yourself. Pan failed");return}this.assignIconSize(a.target);this.settings.pan.target=a.target}else{console.error("Lens: Invalid variable type passed for the %cpSettings.target.xPos || pSettings.target.yPos || *pSettings.target.mapName",
"font-weight: bold","parameter. Pan failed");return}else{console.error("Lens: Invalid variable type passed for the %cpSettings.target","font-weight: bold","property. Pan failed");return}a.ease?"object"===typeof a.ease&&a.ease.constructor===Object?"string"===typeof a.ease.x&&"string"===typeof a.ease.y?k.includes(a.ease.x)&&k.includes(a.ease.y)?(this.settings.pan.ease.x=a.ease.x,this.settings.pan.ease.y=a.ease.y):(this.settings.pan.ease.x=this.settings.pan.ease.y="easeOutCubic",this.debugging&&console.warn("Lens: Invalid %cease",
"font-weight: bold","name passed for pSettings.ease.x || pSettings.ease.y. Reverted to default")):(this.settings.pan.ease.x=this.settings.pan.ease.y="easeOutCubic",this.debugging&&console.warn("Lens: Invalid variable type passed for the %cpSettings.ease.x || pSettings.ease.y","font-weight: bold","parameter. Reverted to default")):"string"===typeof a.ease?k.includes(a.ease)?this.settings.pan.ease.x=this.settings.pan.ease.y=a.ease:(this.settings.pan.ease.x=this.settings.pan.ease.y="easeOutCubic",this.debugging&&
console.warn("Lens: Invalid %cease","font-weight: bold","name passed for pSettings.ease.x || pSettings.ease.y. Reverted to default")):(this.settings.pan.ease.x=this.settings.pan.ease.y="easeOutCubic",this.debugging&&console.warn("Lens: Invalid variable type passed for the %cpSettings.ease","font-weight: bold","property. Reverted to default")):(this.settings.pan.ease.x=this.settings.pan.ease.y="easeOutCubic",this.debugging&&console.warn("Lens: No %cease","font-weight: bold","property included inside of the pSettings parameter. Reverted to default"));
